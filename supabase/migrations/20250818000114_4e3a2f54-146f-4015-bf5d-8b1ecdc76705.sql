...
CREATE TABLE public.ubicaciones_tiempo_real (
    ...
    INDEX idx_ubicaciones_camion_timestamp (camion_id, timestamp DESC)
);
...
CREATE TABLE public.cruces_registrados (
    ...
    INDEX idx_cruces_camion_timestamp (camion_id, timestamp DESC)
);
...
CREATE TABLE public.alertas (
    ...
    INDEX idx_alertas_estado_prioridad (estado, prioridad, timestamp DESC)
);
